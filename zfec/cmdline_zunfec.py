...
def main():
    if '-V' in sys.argv or '--version' in sys.argv:
        ...
        print("zunfec command-line tool version: {}".format(__version__))
        return 0
    ...
    parser.add_argument('-o', '--outputfile', required=True,
                        help='file to write the resulting data to, or "-" for stdout', type=str, metavar='OUTF')
    parser.add_argument('sharefiles', nargs='*',
                        help='shares file to read the encoded data from', type=str, metavar='SHAREFILE')
    parser.add_argument(
        '-v', '--verbose', help='print out messages about progress', action='store_true')
    parser.add_argument(
        '-f', '--force', help='overwrite any file which already in place of the output file', action='store_true')
    parser.add_argument(
    ...
    if args.force:
        ...
        try:
            ...
            print("There is already a file named {} -- aborting.  Use --force to overwrite.".format(args.outputfile))
            return 2
